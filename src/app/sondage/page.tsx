...
export default function SondagePage() {
      ...
      <div className="min-h-screen flex items-center justify-center bg-[radial-gradient(circle_at_top,_#2a073f,_#120238,_#020114)]">
        <div className="max-w-md w-full space-y-8 p-8">
          <div className="card card-compact bg-[#0f0035]/80 backdrop-blur-lg shadow-[0_0_24px_rgba(189,1,255,0.5)] border border-[#9f4eff] p-8 text-center">
            ...
            <h2 className="text-3xl font-bold text-slate-100 mb-2">Sondage créé !</h2>
            <p className="text-[#d3c6ff]">Redirection vers l&apos;accueil...</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[radial-gradient(circle_at_top,_#2a073f,_#120238,_#020114)] py-8">
      <div className="max-w-2xl w-full space-y-8 p-8">
        <div className="card card-compact bg-[#0f0035]/80 backdrop-blur-lg shadow-[0_0_24px_rgba(189,1,255,0.5)] border border-[#9f4eff] p-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-slate-100 mb-2">Créer un sondage</h2>
            <p className="text-[#d3c6ff]">Posez votre question et proposez des options</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="question" className="block text-sm font-semibold text-[#dcd6ff] mb-2">
                Question du sondage
              </label>
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                <label className="block text-sm font-semibold text-[#dcd6ff]">
                  Options de réponse
                </label>
                <button
                  type="button"
                  onClick={addOption}
                  className="flex items-center px-3 py-1 text-sm bg-[#380d4f]/70 text-[#cdaaff] rounded-lg hover:bg-emerald-200 transition-colors duration-200"
                >
                ...
                {options.map((option, index) => (
                  <div key={index} className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 pl-12 pr-12 border border-[#5f33ac] rounded-xl text-white placeholder-[#b4aafc] focus:border-[#a100ff] focus:ring-2 focus:ring-[#8b4bff] transition-all duration-200 bg-[#130034] focus:bg-[#110028]/85"
                      required
                    />
                    <svg className="w-5 h-5 text-[#a99cff] absolute left-4 top-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {options.length > 2 && (
                      <button
                        ...
                        className="absolute right-3 top-3.5 text-[#a99cff] hover:text-red-500 transition-colors duration-200"
                      >
          ...
          <div className="mt-8 text-center">
            <a href="/" className="text-[#8f7cfe] hover:text-[#cdaaff] font-semibold transition-colors duration-200">
              ← Retour à l&apos;accueil
            </a>
          </div>
        </div>
